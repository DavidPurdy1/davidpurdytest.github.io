//Credits to https://1000mileworld.com/Portfolio/Piano/keyboard.html
    //for most of the work getting rid of a few modifications
            ...
            for(var n in notes) {
                if(n[2]!='b') {
                    ...
                    if(n.length>1) { //adding sharp sign makes 2 characters
                        ...
                        thisKey.style.left = (35 * (iWhite - 1)) + 20 + 'px';
                    } else {
                        thisKey.className = 'white key';
                        thisKey.style.width = '35px';
                        thisKey.style.height = '200px';
                        thisKey.style.left = 35 * iWhite + 'px';
                        iWhite++;
                    }
